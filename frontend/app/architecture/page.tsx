...
export default function ArchitecturePage() {
  ...
  const archBlocks = [
    ...
    { step: '02', icon: Search, title: { en: 'Entity Graph', ar: 'رسم الكيانات' }, desc: { en: '76 real GCC entities across 5 layers — geography, infrastructure, economy, finance, society — connected by 190 weighted causal edges with explicit polarity.', ar: '76 كياناً خليجياً حقيقياً عبر 5 طبقات — الجغرافيا، البنية التحتية، الاقتصاد، المالية، المجتمع — مرتبطة بـ 190 رابط سببي مرجح مع قطبية صريحة.' }, features: [{ en: '76 nodes', ar: '76 عقدة' }, { en: '190 weighted edges', ar: '190 رابط مرجح' }, { en: '5 causal layers', ar: '5 طبقات سببية' }, { en: 'Bilingual labels', ar: 'تسميات ثنائية اللغة' }] },
  ...
  const layers = [
    ...
    { name: { en: 'Economy', ar: 'الاقتصاد' }, color: '#5B7BF8', nodes: { en: 'Oil Export, Aramco, ADNOC, KPC, Shipping, Aviation, Fuel, GDP, Tourism, 6 Airlines, Aviation Stress, Logistics', ar: 'صادرات النفط، أرامكو، أدنوك، KPC، الشحن، الطيران، الوقود، الناتج المحلي، السياحة، 6 خطوط طيران، ضغط الطيران، الخدمات اللوجستية' }, count: 17 },
