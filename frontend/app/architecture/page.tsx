...
export default function ArchitecturePage() {
  ...
  const archBlocks = [
    ...
    { step: '02', icon: Search, title: { en: 'Entity Graph', ar: 'رسم الكيانات' }, desc: { en: '39 real GCC entities across 5 layers — geography, infrastructure, economy, finance, society — connected by 66 weighted causal edges with explicit polarity.', ar: '39 كياناً خليجياً حقيقياً عبر 5 طبقات — الجغرافيا، البنية التحتية، الاقتصاد، المالية، المجتمع — مرتبطة بـ 66 رابط سببي مرجح مع قطبية صريحة.' }, features: [{ en: '39 nodes', ar: '39 عقدة' }, { en: '66 weighted edges', ar: '66 رابط مرجح' }, { en: '5 causal layers', ar: '5 طبقات سببية' }, { en: 'Bilingual labels', ar: 'تسميات ثنائية اللغة' }] },
