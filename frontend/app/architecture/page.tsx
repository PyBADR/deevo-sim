...
export default function ArchitecturePage() {
  ...
  const archBlocks = [
    ...
    { step: '02', icon: Search, title: { en: 'Entity Graph', ar: 'رسم الكيانات' }, desc: { en: '53 real GCC entities across 5 layers — geography, infrastructure, economy, finance, society — connected by 98 weighted causal edges with explicit polarity.', ar: '53 كياناً خليجياً حقيقياً عبر 5 طبقات — الجغرافيا، البنية التحتية، الاقتصاد، المالية، المجتمع — مرتبطة بـ 98 رابط سببي مرجح مع قطبية صريحة.' }, features: [{ en: '53 nodes', ar: '53 عقدة' }, { en: '98 weighted edges', ar: '98 رابط مرجح' }, { en: '5 causal layers', ar: '5 طبقات سببية' }, { en: 'Bilingual labels', ar: 'تسميات ثنائية اللغة' }] },
