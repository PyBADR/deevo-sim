...
export default function ArchitecturePage() {
  ...
  const archBlocks = [
    ...
    { step: '02', icon: Search, title: { en: 'Entity Graph', ar: 'رسم الكيانات' }, desc: { en: '68 real GCC entities across 5 layers — geography, infrastructure, economy, finance, society — connected by 145 weighted causal edges with explicit polarity.', ar: '68 كياناً خليجياً حقيقياً عبر 5 طبقات — الجغرافيا، البنية التحتية، الاقتصاد، المالية، المجتمع — مرتبطة بـ 145 رابط سببي مرجح مع قطبية صريحة.' }, features: [{ en: '68 nodes', ar: '68 عقدة' }, { en: '145 weighted edges', ar: '145 رابط مرجح' }, { en: '5 causal layers', ar: '5 طبقات سببية' }, { en: 'Bilingual labels', ar: 'تسميات ثنائية اللغة' }] },
