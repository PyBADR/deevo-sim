        ...
        <React.Fragment key={s}>
          <div
            className={`px-2 py-1 text-xs rounded transition-colors ${
              idx <= currentIndex
                ? "bg-io-accent/10 text-io-accent border border-io-accent/20"
          ...
          {idx < statusList.length - 1 && (
            <div
              className={`h-0.5 w-2 ${idx < currentIndex ? "bg-io-accent/40" : "bg-slate-200"}`}
            />
          )}
        </React.Fragment>
      ))}
        ...
        <div className="flex flex-wrap items-center gap-4">
          {currentScenario && (
            <div>
              ...
              <p className="text-sm font-semibold text-io-accent">{currentScenario}</p>
            </div>
          )}
          {runId && (
            <div>
            ...
            <div className="flex justify-between text-sm">
              ...
              <div className="flex items-center gap-2">
                <div className="w-24 h-2 bg-slate-100 rounded-full overflow-hidden border border-slate-200">
                  <div
                    className="h-full bg-gradient-to-r from-io-status-low to-io-accent rounded-full"
              ...
              <div key={decision.id} className="bg-white p-3 rounded border border-slate-200 shadow-sm">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="text-right">
                    <span className="inline-block px-2 py-1 text-xs bg-io-accent/10 text-io-accent rounded border border-io-accent/20">
                      P{decision.priority}
                    </span>
                  </div>
                </div>
          ...
          <div className="bg-io-accent/5 border border-io-accent/15 rounded-lg p-4">
            ...
            <div className="grid grid-cols-3 gap-3 mt-3">
              <div className="bg-white rounded-lg p-3 border border-slate-200 text-center">
                <p className="text-lg font-bold text-io-accent">—</p>
                <p className="text-[10px] text-slate-500 uppercase mt-1">
                  {locale === "ar" ? "قرارات مسجلة" : "Decisions Recorded"}
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 border border-slate-200 text-center">
                <p className="text-lg font-bold text-io-status-low">—</p>
                <p className="text-[10px] text-slate-500 uppercase mt-1">
                  {locale === "ar" ? "نتائج مؤكدة" : "Outcomes Confirmed"}
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 border border-slate-200 text-center">
                <p className="text-lg font-bold text-io-status-elevated">—</p>
                <p className="text-[10px] text-slate-500 uppercase mt-1">
